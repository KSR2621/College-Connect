...
const PostCard: React.FC<PostCardProps> = (props) => {
  ...
  if (post.isEvent && post.eventDetails) {
    ...
    return (
        <div 
            className={`bg-card rounded-xl shadow-card hover:shadow-card-hover flex flex-col overflow-hidden transition-shadow duration-300 group border border-border ${animationClass}`}
            style={animationStyle}
        >
  ...
  if (post.isOpportunity && post.opportunityDetails) {
    ...
    return (
        <div 
            className={`bg-card rounded-xl shadow-card hover:shadow-card-hover flex flex-col transition-shadow duration-300 group overflow-hidden border border-border ${animationClass}`}
            style={animationStyle}
        >
  ...
  return (
    <div
        className={`bg-card rounded-xl shadow-card transition-shadow duration-300 border border-border ${animationClass}`}
        style={animationStyle}
    >
      {/* Post Header */}
