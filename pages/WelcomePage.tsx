...
const WelcomePage: React.FC<WelcomePageProps> = ({ onNavigate }) => {
    return (
        <div className="min-h-screen bg-gradient-to-br from-white to-slate-100 flex flex-col items-center justify-center text-center p-4">
            <div className="max-w-2xl animate-fade-in">
                ...
                <div className="mt-8 flex flex-col sm:flex-row items-center justify-center gap-4">
                    ...
                    <button
                        ...
                        className="w-full sm:w-auto px-8 py-3 text-lg font-semibold text-primary bg-white border-2 border-primary rounded-lg shadow-md hover:shadow-lg focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-primary transition-all transform hover:scale-105"
                    >
                        Sign Up
                    </button>
                </div>
